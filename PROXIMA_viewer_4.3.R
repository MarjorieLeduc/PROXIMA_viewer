  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "StatPlot",
              ...
              numericInput("SignifThreashold", "Significant threashold value", 0.05),
              numericInput("FCThreashold", "Fold change threashold value (1 means no differences)", 1),
...
server <- function(input, output, session) {
  ...
  # observeEvent(input$dataFile$datapath, {
    ...
    updateNumericInput(
      inputId = "SignifThreashold",
      value = as.numeric(x[2])/100
    )
    
    updateNumericInput(
      inputId = "FCThreashold",
